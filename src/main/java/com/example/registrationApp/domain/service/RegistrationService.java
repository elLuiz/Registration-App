...
import com.example.registrationApp.api.utils.EmailValidator;
import com.example.registrationApp.domain.exception.client.ClientException;
import com.example.registrationApp.domain.mail.EmailSender;
import com.example.registrationApp.domain.model.AppUser;
import com.example.registrationApp.domain.model.UserRole;
...
public class RegistrationService {
    ...
    public String register(RegistrationModel registrationModel){
        boolean isValidEmail = emailValidator.test(registrationModel.getEmail());
        if(isValidEmail){
